...
create table Tweet (
  ...
  , TweetTextjp VARCHAR(max) not null
  , TweetTextcn VARCHAR(max) not null
  , TweetTexten VARCHAR(max) not null
...
EXECUTE sp_addextendedproperty N'MS_Description', N'ツイート内容日本語	 日本語のツイート内容', N'SCHEMA', N'dbo', N'TABLE', N'Tweet', N'COLUMN', N'TweetTextjp';
EXECUTE sp_addextendedproperty N'MS_Description', N'ツイート内容中国語	 中国語のツイート内容', N'SCHEMA', N'dbo', N'TABLE', N'Tweet', N'COLUMN', N'TweetTextcn';
EXECUTE sp_addextendedproperty N'MS_Description', N'ツイート内容英語	 英語のツイート内容', N'SCHEMA', N'dbo', N'TABLE', N'Tweet', N'COLUMN', N'TweetTexten';
